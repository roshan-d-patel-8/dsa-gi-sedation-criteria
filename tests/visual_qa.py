...
with sync_playwright() as playwright:
    ...
    assert desktop.get_by_text("MAC only for high-dose or long-acting narcotics:", exact=False).is_visible()
    ...
    assert desktop.get_by_text("Norco, Percocet, or Vicodin: MAC if using >4 tabs/day.", exact=True).is_visible()
